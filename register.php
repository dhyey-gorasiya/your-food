                      ...
                      <div class="row" style="width: 100%">
                        <div class="col-md-12">
                          <form class="form-register" action="manage-insert.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group input-with-icon">
                              <input autocomplete="off" type="text" name="phone" class="form-control" pattern="[1-9]{1}[0-9]{9}" required="" minlength="10" maxlength="10" placeholder="Phone">
                      ...
                      <div class="row" style="width: 100%">
                        <div class="col-md-12">
                          <form class="form-register" action="manage-insert.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group input-with-icon">
                              <input autocomplete="off" type="text" name="phone" class="form-control" pattern="[1-9]{1}[0-9]{9}" required="" minlength="10" maxlength="10" placeholder="Restaurant Phone">
                              <i class="fas fa-phone-square-alt fa-lg fa-fw" aria-hidden="true"></i>
                            </div>
                            <div class="form-group input-with-icon">
                            ...
                            <div class="row hours-spacing">
                              <div class="col">
                                ...
                                <input type="time" name="opening_res" class="" required="" min="06:00" max="15:00">
                                <br />
                                <label for="close" class="label-spacing">Closing</label>
                                <input type="time" name="closing_res" class="" required="" min="15:00" max="00:00">
                              </div>
                            </div>
