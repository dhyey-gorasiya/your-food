...
<body>
	...
	<section class="body-sign">
		<div class="circle-login">YourFood </div>
			...
			<div class="panel panel-sign">
				...
				<div class="panel-body">
					<form action="" method="POST">
						...
						<p class="text-center">I don't have an account yet? <a href="../register.php">Register!</a>
					</form>
				</div>
			</div>
...
if (isset($_POST['login'])) {
	...
	$emailSQL = "SELECT * FROM admin_info WHERE email = '$email';";

	$emailResult = $con->query($emailSQL);

	$passwordSQL = "SELECT * FROM admin_info WHERE email = '$email' and password=?;";
