				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>List of Category</span></li>
						</ol>
								...
								?>
									<tr class="gradeX">
										...
										<td class="center hidden-phone">
											...
											<a href="menu-manage.php?menu_id=<?php echo $r['id'];?>&status=<?php echo $r['isActive'];  ?>" class="btn btn-danger btn-sm" onclick="if (!Done()) return false; "><?php echo $r['isActive'] == 1 ? "deactive" :  "active" ?> </a>
										</td>
									</tr>
								<?php $count++;
								} ?>
