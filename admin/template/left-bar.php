...
<aside id="sidebar-left" class="sidebar-left">
							...
							<ul class="nav nav-children">
								...
								<li>
									<a href="booking-list.php">
										...
										<span>List of Available User</span>
									</a>
								</li>
							</ul>
						</li>
							...
							<ul class="nav nav-children">
								...
								<li>
									<a href="person-table-list.php">
										<span class="pull-right label label-info">List</span>
										<i class="fas fa-list-ul" aria-hidden="true"></i>
										<span>List of Available Restaurant</span>
									</a>
								</li>
							</ul>
						</li>
							...
							<ul class="nav nav-children">
								...
								<li>
									<a href="menu-list.php">
										<span class="pull-right label label-info">List</span>
										<i class="fas fa-list-ul" aria-hidden="true"></i>
										<span>Liste of Available Category</span>
									</a>
								</li>
							</ul>
						</li>
							...
							<ul class="nav nav-children">
								...
								<li>
									<a href="city-list.php">
										<span class="pull-right label label-info">List</span>
										<i class="fas fa-list-ul" aria-hidden="true"></i>
										<span>Liste of Available City</span>
									</a>
								</li>
							</ul>
						</li>
	...
	<div class="logo-bookeat" id="logo-bookeat">
		<span class="text-1">Your Food</span>
