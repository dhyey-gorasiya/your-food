          ...
          <div id="menu-wrapper">
            <div class="container-fluid">
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'Menu' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
              ...
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'Entree' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
              ...
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'Dish' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
              ...
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'SideDish' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
              ...
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'Dessert' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
              ...
              <div class="container">
                ...
                $res_id = $_GET['res_id'];
                $con = connect();
                $sql = "SELECT * FROM `menu_item` WHERE res_id = $res_id AND food_type = 'Drinks' AND isActive='1'";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
