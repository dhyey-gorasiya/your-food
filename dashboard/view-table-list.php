								...
								?>
									<tr class="gradeX">
										...
										<td class="center hidden-phone">
											...
											<a href="delete-table-num.php?table_id=<?php echo $r['id'];?>&tbl_id=<?php echo $tbl_id; ?>&status=<?php echo $r['isActive'];  ?>" class="btn btn-danger btn-sm" onclick="if (!Done()) return false; "><?php echo $r['isActive'] == 1 ? "deactive" :  "active" ?> </a>
										</td>
									</tr>
								<?php $count++;
								} ?>
