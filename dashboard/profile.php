                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      ...
                      <div class="col-md-4">
                        ...
                        foreach ($result as $r) {
                        ?>
                          <input type="time" id="opening_res" name="opening_res" min="06:00" max="15:00" value="<?php echo date('H:i', strtotime($r['opening_res'])); ?>">
                        <?php
                        }
                        ?>
                      </div>
                      <div class="col-md-4">
                        ...
                        foreach ($result as $r) {
                        ?>
                          <input type="time" id="closing_res" name="closing_res" min="15:00" max="00:00" value="<?php echo date('H:i', strtotime($r['closing_res'])); ?>">
                        <?php
                        }
                        ?>
                      </div>
