	...
	foreach ($result8 as $r8) {
		...
		if ($con->query($sql) === TRUE) {
			...
			<body style="margin: 0 !important; padding: 0 !important;">
				...
				<div class="preheader">
				&#127858; Status of your booking with Your Food.
				</div>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapper">
								<tr>
									<td align="center" valign="top" class="hero-headline">
										<span class="h1 textColorWhite">Reservation will cancel</span>
									</td>
								</tr>
								<tr>
														...
														<table border="0" cellspacing="0" cellpadding="0" width="100%">
															...
															<tr>
																<td align="center" valign="center">
																	<span class="button-text">Visit Your Food</span>
																</td>
															</tr>
															<tr>
																<td style="height:18px; line-height:18px;">&nbsp;</td>
								...
								<tr>
									<td align="center" class="message-text">
										...
										<div class="textMedium">
											...
											Your booking is cancel by the restaurant, for the ' . date("d/m/Y", strtotime($r8["booking_date"])) . ' at ' . $r8["booking_time"] . ' <br>
											Thank you !
										</div>
									</td>
								</tr>
			...
			$mail->addAddress($email, "Booking Cancel");
			if ($mail->send()) {
				echo '<script>
                        swal("This reservation has been cancel!", "An Cancelation email will be sent to the customer.", "success").then(function() {
								...
								<tr>
									<td align="center" class="message-text">
										...
										<div class="textMedium">
											...
											Thank you and see you soon with Your Food !
										</div>
									</td>
								</tr>
								<tr>
