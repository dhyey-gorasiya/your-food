                ...
                <div class="tab-content py-5" id="v-pills-tabContent">
                  <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    <div class="row">
                      ...
                      $sql = "SELECT `id`, `person_num` FROM `restaurant_tables` WHERE res_id = $location and isActive='1'";
                      $result = $con->query($sql);
                      foreach ($result as $r) {
                        $table_id = $r['id'];
                      ?>
                        <div class="col-lg-3" style="min-height: 190px">
                          <p class="text-center" style="font-weight: bold; color: grey;">Table of <?php echo $r['person_num']; ?></p>
                          <nav class="menu2">
                            <ul style="list-style-type: none;">
                              <?php
                              $sql2 = "SELECT * FROM `restaurant_personne` WHERE tbl_id = '$table_id'and isActive='1'";
