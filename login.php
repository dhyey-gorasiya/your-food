...
if (isset($_POST['login'])) {
  ...
  $con = connect();
  $emailSQL = "SELECT * FROM rc_info WHERE email = '$email' AND isActive='1'";
  $emailResult = $con->query($emailSQL);
  $passwordSQL = "SELECT * FROM rc_info WHERE email = '$email' And password=? AND isActive='1'";
