                  ...
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user fa-lg fa-fw mr-1" aria-hidden="true"></i> First Name : </span> <input style="text-transform: capitalize;" type="text" name="first_name" class="form-control no-outline" required="" placeholder="first name" value="<?php echo $row['first_name']; ?>"></p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user-tag fa-lg fa-fw mr-1" aria-hidden="true"></i> Last Name :</span> <input style="text-transform: capitalize;" type="text" name="fullname" class="form-control" required="" placeholder="last name" value="<?php echo $row['rc_name']; ?>"> </p>
                      </div>
                    </div>
                  </div>
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-phone-square-alt fa-lg fa-fw mr-1" aria-hidden="true"></i> Phone : </span> <input type="number" name="phone" class="form-control" required="" minlength="10" maxlength="10" placeholder="phone" value="<?php echo $row['phone']; ?>"></p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
